package net.runelite.client.plugins.glglassblower;
...
@PluginDescriptor(
        name = "glglassblower",
        description = "blows glass - up to orbs",
        tags = {"crafting", "glass", "goonlite"},
        enabledByDefault = false
)
public class glglassblowerPlugin extends Plugin {
    ...
    @Inject
    private glglassblowerConfig config;

    @Provides
    glglassblowerConfig provideConfig(ConfigManager configManager)
    {
        return configManager.getConfig(glglassblowerConfig.class);
    }
    ...
    protected void startUp() throws Exception
    {
        ...
        status = "Starting up.";
        break_end = "Unknown";
        String command = "/runelite-client/src/main/resources/net/runelite/client/AutoOldSchool/crafting/blow_glass_v3.py";

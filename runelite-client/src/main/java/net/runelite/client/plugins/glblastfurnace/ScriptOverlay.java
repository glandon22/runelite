...
import net.runelite.client.plugins.glblastfurnace.GlBlastFurnacePlugin;
...
public class ScriptOverlay extends OverlayPanel {
    private final GlBlastFurnacePlugin plugin;

    @Inject
    private ScriptOverlay(GlBlastFurnacePlugin plugin) {
        super(plugin);
